...
import { Github, Linkedin, Mail, User, Briefcase, Home as HomeIcon, Award, GraduationCap } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex space-x-8">
              ...
              <button onClick={() => scrollToSection('certificates')} className="text-gray-600 hover:text-gray-900">
                <Award className="w-5 h-5" />
              </button>
              <button onClick={() => scrollToSection('portfolio')} className="text-gray-600 hover:text-gray-900">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <p className="text-gray-600 mb-4">
                ...
                With a strong foundation in both front-end and back-end development, I create elegant solutions
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 rounded-lg shadow-lg overflow-hidden">
              ...
              />
              <div className="p-6">
                <h3 className="font-bold text-xl mb-2">React Advanced Certification</h3>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[1, 2, 3, 4, 5, 6].map((item) => (
              <div key={item} className="bg-white rounded-lg shadow-lg overflow-hidden">
                <img
                  src={`https://images.unsplash.com/photo-${1550439062 + item}-e214c965db21?auto=format&fit=crop&w=500&h=300`}
                  alt={`Project ${item}`}
                  className="w-full h-48 object-cover"
                />
                <div className="p-6">
